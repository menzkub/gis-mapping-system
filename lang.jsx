...
const TRANSLATIONS = {
  th: {
    ...
    searchHintDesc: "พิมพ์ TAG, PEANO, หรือหมายเลขผู้ใช้ ในช่องค้นหาด้านบน",
    mapSearchHint: "พิมพ์คำค้นหาเพื่อดูตำแหน่งบนแผนที่",
    exportNeedSearch: "ค้นหาข้อมูลก่อนเพื่อส่งออก",
    corrTitle: "แจ้งแก้ไขพิกัด", corrLatNew: "Latitude ใหม่", corrLngNew: "Longitude ใหม่", corrNote: "หมายเหตุ (ไม่บังคับ)",
    ...
    admMap: "แผนที่ภาพรวม",
    admImport: "นำเข้าข้อมูล", admAudit: "Audit Log", admSettings: "ตั้งค่าระบบ",
    admProfile: "ข้อมูลฉัน", admMobProfile: "ข้อมูลฉัน",
    ...
    unknownM: "ไม่ระบุ (M)", unknownTr: "ไม่ระบุ (TR)", unknownLabel: "ไม่ระบุ",
    ...
    authEmailOrUsername: "อีเมลหรือ Username",
    authLoginDesc2: "กรอกอีเมล หรือ Username และรหัสผ่านเพื่อเข้าสู่ระบบ",
    authUsernameNotFound: "ไม่พบ Username นี้ในระบบ",
  ...
  en: {
    ...
    searchHintDesc: "Type TAG, PEANO, or account number in the search box above",
    mapSearchHint: "Type a keyword to see locations on map",
    exportNeedSearch: "Search first to enable export",
    corrTitle: "Report Coordinate Error", corrLatNew: "New Latitude", corrLngNew: "New Longitude", corrNote: "Note (optional)",
    ...
    admMap: "Overview Map",
    admImport: "Import Data", admAudit: "Audit Log", admSettings: "System Settings",
    admProfile: "My Account", admMobProfile: "My Account",
    ...
    unknownM: "Unknown (M)", unknownTr: "Unknown (TR)", unknownLabel: "Unknown",
    ...
    authLoginDesc2: "Enter your email or username and password to sign in",
    authUsernameNotFound: "Username not found in the system",
